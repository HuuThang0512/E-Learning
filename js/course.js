...
function renderCourse(courses) {
  courses.forEach((course) => {
    ...
    <div class="course-image"> <img class="course-img" srcSet="${course.img}" alt="course-img"/></div>
              <div class="course-type-name"> 
                <p class="course-type type" style="--color: #342F98">${course.type}</p>
              ...
              <div class="course-rate-amount">
                <div class="course-rating rating"> 
                  ...
                  </svg><span class="course-rating-point rating-point">${course.rating}</span>
                </div>
